...
class SessionHelper
{
    ...
    {
        $sql = "SELECT cli_nom,cli_prenom,cli_courriel,cli_telephone,cli_ville,cli_nb_points_ec,cli_nb_points_tot,type_nom FROM vik_client  join vik_type_client USING (typ_num) WHERE cli_num = :num";
